...
//       } else {
//         setFuelPurchases(
//           fuelPurchases.map((transaction) =>
//             transaction.id === selectedTransactionId
//               ? { ...transaction, amount, category, liters, date }
//               : transaction
//           )
//         );
...
//               {selectedTransactionId ? "Update Transaction" : "Add Transaction"}
//             </h1>
//           </div>
//           <div>
...
//                 {selectedTransactionId ? "updated" : "added"}.
//               </span>
//             </div>
//           )}
//           <div className="mb-4">
...
//               onChange={(e) => setSelectedTransactionId(Number(e.target.value))}
//               className="w-full p-4 text-black bg-white rounded-xl border-2 border-black shadow-[4px_4px_0px_rgba(0,0,0,0.8),0_0px_0px_rgba(0,0,0,0.8)]"
//             >
//               <option value="">Select a transaction</option>
//               {fuelPurchases.map((purchase) => (
//                 <option key={purchase.id} value={purchase.id}>
//                   {purchase.date} - {purchase.category} - ${purchase.amount}
//                 </option>
//               ))}
//             </select>
//           </div>
